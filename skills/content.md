...
| `rak_meta_list_sources` | 4,800+ monitored sources (live) + curated census of 1,709 local outlets (belongs to `meta`/discovery — see [discovery](./discovery.md)) | anon (no key) |
